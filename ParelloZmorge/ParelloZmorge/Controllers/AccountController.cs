    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
				...
				var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Prename = model.Prename, Surname = model.Surname, WorkPlaceHint = model.WorkPlaceHint };
				...
				if (result.Succeeded)
				{
					...
					{
						_userManager.AddToRole(user.Id, "Mitarbeiter");
					}
